...
public class CsvUnescapedQuoteTokenizer extends Tokenizer {
	
	public CsvUnescapedQuoteTokenizer(Reader reader, CsvPreference preferences) {
	...
	protected String readLine() throws IOException {
		...
		for (int i = b.length() - 1; i >= 0; i--) {
			if (quote == b.charAt(i)) {
				final boolean validCharBefore = i - 1 < 0 || b.charAt(i - 1) == delimiter;
